...
var AllSettings = []Definition{
	...
	{Key: constant.KeyCommentAIDetectEnable, Value: "false", Comment: "是否启用AI敏感词检测 (true/false)", IsPublic: false},
	{Key: constant.KeyCommentAIDetectAPIURL, Value: "https://v1.nsuuu.com/api/AiDetect", Comment: "AI敏感词检测API地址", IsPublic: false},
	{Key: constant.KeyCommentAIDetectAPIKey, Value: "", Comment: "AI敏感词检测API密钥（如需要）", IsPublic: false},
