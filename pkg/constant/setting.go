...
const (
	...
	KeyCommentAIDetectEnable    SettingKey = "comment.ai_detect_enable"
	KeyCommentAIDetectAPIURL    SettingKey = "comment.ai_detect_api_url"
	KeyCommentAIDetectAPIKey    SettingKey = "comment.ai_detect_api_key"
